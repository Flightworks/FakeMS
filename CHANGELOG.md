...
### Fixed
- **STAB Toggle Regression**: Fixed a typo in the sidebar logic that prevented switching from H/C mode into GND mode.

### Added
- **Sidebar Unit Tests**: Created `tests/components/LeftSidebar.test.tsx` to provide automated coverage for panel interactions and stabilization toggles.
