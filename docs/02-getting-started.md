...
- **Map not showing**: The tactical basemap is local and does not require Internet access. Check that the application build contains `maps/ne_110m_land.geojson`, `maps/ne_10m_land_toulon.geojson`, and `maps/ne_10m_airports_major.geojson`.
