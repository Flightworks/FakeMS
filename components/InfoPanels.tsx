...
export const TargetPanel = React.memo(({ entity, animationSpeed = 300 }: { entity: Entity | null, animationSpeed?: number }) => {
  ...
  return (
    ...
    >
       ...
       <div className="p-2 grid grid-cols-3 gap-3 bg-slate-950/90">
             <DataField label="BRG" value="038" unit="°" />
             <DataField label="DIST" value="12.4" unit="NM" />
             <DataField label="ALT" value="00483" unit="ft" />
       </div>
       <div className="px-2 pb-1 bg-slate-950/90">
          <div className="text-right text-[10px] font-mono text-slate-400">
            N34°06.007 E005°55.464
          </div>
       </div>
    </div>
  );
